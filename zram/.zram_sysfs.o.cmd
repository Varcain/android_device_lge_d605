cmd_/opt/android/system/device/lge/d605/zram/zram_sysfs.o := /opt/android/system/kernel/lge/d605/scripts/gcc-wrapper.py arm-eabi-gcc -Wp,-MD,/opt/android/system/device/lge/d605/zram/.zram_sysfs.o.d  -nostdinc -isystem /opt/android/system/prebuilts/gcc/linux-x86/arm/arm-eabi-4.6/bin/../lib/gcc/arm-eabi/4.6.x-google/include -I/opt/android/system/kernel/lge/d605/arch/arm/include -Iarch/arm/include/generated -Iinclude  -I/opt/android/system/kernel/lge/d605/include -include /opt/android/system/kernel/lge/d605/include/linux/kconfig.h   -I/opt/android/system/device/lge/d605/zram -D__KERNEL__ -mlittle-endian   -I/opt/android/system/kernel/lge/d605/arch/arm/mach-msm/include -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Werror-implicit-function-declaration -Wno-format-security -fno-delete-null-pointer-checks -Os -marm -fno-dwarf2-cfi-asm -fstack-protector -mabi=aapcs-linux -mno-thumb-interwork -funwind-tables -D__LINUX_ARM_ARCH__=7 -mcpu=cortex-a15 -msoft-float -Uarm -Wframe-larger-than=1024 -Wno-unused-but-set-variable -fomit-frame-pointer -g -Wdeclaration-after-statement -Wno-pointer-sign -fno-strict-overflow -fconserve-stack -Wall -Wdeprecated-declarations  -DMODULE  -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(zram_sysfs)"  -D"KBUILD_MODNAME=KBUILD_STR(zram)" -c -o /opt/android/system/device/lge/d605/zram/.tmp_zram_sysfs.o /opt/android/system/device/lge/d605/zram/zram_sysfs.c

source_/opt/android/system/device/lge/d605/zram/zram_sysfs.o := /opt/android/system/device/lge/d605/zram/zram_sysfs.c

deps_/opt/android/system/device/lge/d605/zram/zram_sysfs.o := \
...
/opt/android/system/device/lge/d605/zram/zram_sysfs.o: $(deps_/opt/android/system/device/lge/d605/zram/zram_sysfs.o)
